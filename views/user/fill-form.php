	...
	<head>
		...
		<script type="text/javascript">
			$(document).ready(function() {
				...
				if(localStorage.file1 != "undefined") { $("#user-images-thumbnails").append("<img src='"+localStorage.file1+"'>"); }
				if(localStorage.file2 != "undefined") { $("#user-images-thumbnails").append("<img src='"+localStorage.file2+"'>"); }
				if(localStorage.file3 != "undefined") { $("#user-images-thumbnails").append("<img src='"+localStorage.file3+"'>"); }
